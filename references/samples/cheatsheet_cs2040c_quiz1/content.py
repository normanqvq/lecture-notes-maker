...
def tree_svg():
    ...
    s.append('<text x="284" y="14" font-size="6.5" fill="#0b2d6b">root=41, n=10</text>')
    s.append('<text x="284" y="23" font-size="6.5" fill="#0b2d6b">height=3</text>')
    s.append('<text x="284" y="32" font-size="6.5" fill="#0b2d6b">leaves: 11 32</text>')
    s.append('<text x="284" y="41" font-size="6.5" fill="#0b2d6b">50 72 99</text>')
    s.append('</svg>')
    return ''.join(s)
